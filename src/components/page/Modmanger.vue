          ...
          <el-table :data="normal" style="width: 100%" max-height="250">
            ...
            <el-table-column label="可用操作" prop="" :key="Math.random()">
              <template slot-scope="scope">
                ...
                <el-button type="warning" icon="el-icon-remove-outline" @click="modcmd('disable',scope.row.modFilename)">禁用</el-button>
                <el-button type="danger" icon="el-icon-delete" @click="modcmd('remove',scope.row.modFilename)">删除</el-button>
        ...
        <el-card class="box-card">
          ...
          <el-table :data="disable" style="width: 100%" max-height="250">
            ...
            <el-table-column label="可用操作" prop="desc" :key="Math.random()">
              <template slot-scope="scope">
              <!-- <el-button type="success" icon="el-icon-check" circle></el-button> -->
                <el-button type="success" icon="el-icon-circle-plus-outline" @click="modcmd('able',scope.row.modFilename)">启用</el-button>
              </template>
